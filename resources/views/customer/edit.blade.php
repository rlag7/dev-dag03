...
@section('content')
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded p-6 mt-6">
        <h2 class="text-2xl font-semibold text-green-700 underline mb-4">
        ...
        <form action="{{ route('customers.update', $customer->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="Voornaam" value="{{ old('Voornaam', $customer->representative->first()->Voornaam ?? '') }}"
            ...
            <div>
                ...
                <input type="text" name="Tussenvoegsel" value="{{ old('Tussenvoegsel', $customer->representative->first()->Tussenvoegsel ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="Achternaam" value="{{ old('Achternaam', $customer->representative->first()->Achternaam ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="date" name="Geboortedatum" value="{{ old('Geboortedatum', $customer->representative->first()->Geboortedatum ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="TypePersoon" value="{{ old('TypePersoon', $customer->representative->first()->TypePersoon ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="Straat" value="{{ old('Straat', $customer->contact->first()->Straat ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="Huisnummer" value="{{ old('Huisnummer', $customer->contact->first()->Huisnummer ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="Toevoeging" value="{{ old('Toevoeging', $customer->contact->first()->Toevoeging ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="Postcode" value="{{ old('Postcode', $customer->contact->first()->Postcode ?? '') }}"
            ...
            <div>
                ...
                <input type="text" name="Woonplaats" value="{{ old('Woonplaats', $customer->contact->first()->Woonplaats ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="email" name="Email" value="{{ old('Email', $customer->contact->first()->Email ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="text" name="Mobiel" value="{{ old('Mobiel', $customer->contact->first()->Mobiel ?? '') }}"
                       class="w-full border rounded px-3 py-2">
            </div>
